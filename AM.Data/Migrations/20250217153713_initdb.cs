        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Natioality = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EffectiveArrival = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EstimetedDuration = table.Column<double>(type: "float", nullable: false),
                    PlaneId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    flightesFlightId = table.Column<int>(type: "int", nullable: false),
                    passengerId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightPassenger", x => new { x.flightesFlightId, x.passengerId });
                    table.ForeignKey(
                        name: "FK_FlightPassenger_Flights_flightesFlightId",
                        column: x => x.flightesFlightId,
